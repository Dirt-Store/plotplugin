    ...
    public void open(Player viewer, Plot plot) {
        ...
        if (canManage) {
            ...
            if (isOwner) {
                ...
                Material transferMat = plugin.getConfigManager().getGuiItemMaterial("plot-gui", "transfer");
                String transferName = plugin.getConfigManager().getGuiItemName("plot-gui", "transfer");
                List<String> transferLore = plugin.getConfigManager().getGuiItemLore("plot-gui", "transfer");
                inv.setItem(transferSlot, ItemBuilder.of(transferMat, transferName, transferLore));
            }
