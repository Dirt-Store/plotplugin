...
public final class PlotDirt extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        // BUG FIX #2: pre-warm the owner-name cache for all existing plots so
        // updateSign() never hits the filesystem on the main thread.
        signManager.warmNameCache();
    ...
    public PlotCommand getPlotCommand() { return plotCommand; }
}
