...
public class WorldGuardManager {
    ...
    /**
     * Set BUILD / CHEST_ACCESS / USE to DENY on the region so that
     * only WG members and owners (added explicitly by this plugin) can interact.
     * WorldGuard's member-bypass makes this work correctly:
     *   non-member = DENY, member/owner = allowed automatically.
     */
