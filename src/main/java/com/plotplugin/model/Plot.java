...
public class Plot {
    ...
    private boolean globalWhitelist; // not stored per-plot, handled by manager
    ...
    public boolean hasAccess(UUID uuid) {
        return isOwner(uuid) || isMember(uuid) || isManager(uuid);
    }
    ...
    /** Expire: clear owner, members, managers */
    public void expire() {
        this.owner = null;
        this.members.clear();
        this.managers.clear();
